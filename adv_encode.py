# This code is from BlenderNeko's Advanced CLIP Text Encode (https://github.com/BlenderNeko/ComfyUI_ADV_CLIP_emb)
...
def advanced_encode_from_tokens(tokenized, token_normalization, weight_interpretation, encode_func, m_token=266, length=77, w_max=1.0):
